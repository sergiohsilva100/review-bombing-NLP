...
df = pd.read_csv("red_read_redemption_2_reviews.csv", names=column_names)
...
topic_model.save("red_dead_redemption_2_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("red_dead_redemption_2_topics_info.csv", index=False)