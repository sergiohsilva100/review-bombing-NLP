...
df = pd.read_csv("inception_reviews.csv", names=column_names)
...
topic_model.save("inception_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("inception_topics_info.csv", index=False)