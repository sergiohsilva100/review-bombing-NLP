...
df = pd.read_csv("days_gone_reviews.csv", names=column_names)
...
topic_model.save("days_gone_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("days_gone_topics_info.csv", index=False)