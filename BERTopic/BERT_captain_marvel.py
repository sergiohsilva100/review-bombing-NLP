...
df = pd.read_csv("captain_marvel_reviews.csv", names=column_names)
...
topic_model.save("captain_marvel_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("captain_marvel_topics_info.csv", index=False)