...
df = pd.read_csv("resident_evil_7_reviews.csv", names=column_names)
...
topic_model.save("resident_evil_7_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("resident_evil_7_topics_info.csv", index=False)