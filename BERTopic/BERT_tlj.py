...
df = pd.read_csv("tlj_reviews.csv", names=column_names)
...
topic_model.save("tlj_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("tlj_topics_info.csv", index=False)