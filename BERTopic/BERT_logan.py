...
df = pd.read_csv("logan_reviews.csv", names=column_names)
...
topic_model.save("logan_reviews_bertopic")
topic_info[["Topic", "Count", "Name", "Representation"]].to_csv("logan_topics_info.csv", index=False)